...
export const POSITIVE_NUMBERS = '123456789';
...
export const CHARS = SYMBOLS + NUMBERS + LETTERS;

export const MIN_DATE = new Date(0); // 1970-01-01
export const MAX_DATE = dayjs().add(10, 'year').toDate(); // 10 years later

export const TEMPLATE_DATETIME = 'YYYY-MM-DD HH:mm:ss';
export const TEMPLATE_DATE = 'YYYY-MM-DD';
export const TEMPLATE_TIME = 'HH:mm:ss';
...
(
  ...
  'Aiden Gabriel Austin Lincoln Eli Ben Harrie ' +
  // Female
  ...
  'Lacey Annie Niamh Lyla Iris Zoe Clara Maddison Fennie'
).split(' ');
...
export const PROTOCOLS = 'ftp http https gopher mailto news nntp telnet wais file prosperos'.split(' ');
